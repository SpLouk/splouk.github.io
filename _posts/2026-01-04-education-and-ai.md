...
AI fears may be partly a [moral panic](https://en.wikipedia.org/wiki/Moral_panic). Still, AI _is_ having an impact on learning in specific and undeniable ways. ChatGPT can write an essay better than many high school and university students, it seems, and many students are all too happy to outsource their essay writing--and critical thinking--to it. Teachers are struggling to prove that essays have been written by AI, and so the value of the whole rigmarole of essay writing and grading seems to be in question.
...
I can't say exactly how this would work and scale. One benefit of written essays is that they can be graded en masse. Maybe traditional grading systems will also have to be reworked in response to the AI disruption. What I do believe strongly is that nothing should be off the table.
